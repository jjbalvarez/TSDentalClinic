...
//activar modal
const modalViews = document.querySelectorAll(".home__modal"),
        modalBtns = document.querySelectorAll(".home__button"),
        modalCloses = document.querySelectorAll(".home__modal-close");
...
var swipers = new Swiper(".galery__container", {
    effect: "cards",
    grabCursor: true,
});
